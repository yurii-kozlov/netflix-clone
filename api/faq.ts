export const faq = [
  {
    ...
    answer: 'Netflix is a streaming service that offers '
    + 'a wide variety of award-winning TV shows, movies, anime,'
...

  {
    ...
    + 'all for one fixed monthly fee. Plans range from EUR4.99 to EUR9.99 a month. No extra costs, no contracts.'
  },

  {
    ...
    + '\n\n You can also download your favorite shows with the iOS, Android, or Windows 10 app. Use downloads'
    + ' to watch while you\'re on the go and without an internet connection. Take Netflix with you anywhere.'
  },

  {
    title: 'How do I cancel?',
    answer: 'Netflix is flexible. There are no pesky contracts and no commitments. You can easily cancel your account '
    + 'online in two clicks. There are no cancellation fees – start or stop your account anytime.'
  },

  {
    title: 'What can I watch on Netflix?',
    answer: 'Netflix has an extensive library of feature films, documentaries, TV shows, anime, award-winning Netflix'
...

  {
    ...
    + 'controls that let you restrict the maturity rating of content kids can watch and block specific '
